...
from beyondcxr.data.bundle_contract import valid_bundle_id
from beyondcxr.data.cxr_transforms import CXR_TRANSFORM_POLICY_VERSION, STANDARD_CXR_IMAGE_SIZE
from beyondcxr.data.rsna_metadata_preprocess import METADATA_INPUT_POLICY_VERSION
from beyondcxr.data.symile_preprocess import LAB_ECDF_POLICY_VERSION
from beyondcxr.data.symile_schemas import ECG_TENSOR_POLICY_VERSION, LABEL_POLICY_VERSION, TASK_ID
from beyondcxr.training.symile_families import SYMILE_ALL_NEURAL_FAMILIES, SYMILE_ECG_GATED_FAMILY
...
def _validate_family_parameters(family_id: str, values: dict[str, Any]) -> None:
    ...
    if family_id == SYMILE_ECG_GATED_FAMILY:
        from beyondcxr.models.symile_ecg_fusion import TRIMODAL_ARCHITECTURE
